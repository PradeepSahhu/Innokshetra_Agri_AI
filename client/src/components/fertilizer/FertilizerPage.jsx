...
function handleClick(navigate) {
  ...
  const nitrogenValue = document.getElementById(
  ...
  const humidityValue = document.getElementById(
    "humidity-fertilizer-input"
  ).value;
  const potassiumValue = document.getElementById(
    "potassium-fertilizer-input"
  ).value;
  const moistureValue = document.getElementById(
    "moisture-fertilizer-input"
  ).value;
  ...
  return (
    <>
      ...
      <LinearProgress
        ...
        className="fertilizer-progress-bar"
      />
      <p className="fertilizer-p">
        {" "}
        Enter soil characteristics & crop you are growing to find best{" "}
        <b> FERTILIZER </b> for your farm 👩‍🌾🌽🚜{" "}
      </p>
      <div className="fertilizer-container">
        <TextField
          id="nitrogen-fertilizer-input"
        ...
        <CropTypeSelectField />
        <TextField
          id="phosphorous-fertilizer-input"
        ...
        />
        <TextField
          id="moisture-fertilizer-input"
          label="Moisture in the soil"
          variant="outlined"
          color="success"
          type="number"
        />
        <button
          className="predict_fertilizer_btn"
          onClick={() => {
            handleClick(navigate);
          }}
        >
