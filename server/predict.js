...
export const getAiResponse = async (prompt) => {
    const prePromptData = `You are a AI farming assistant. You will be sent some ata by a user and you have a preidct a crop from 
    ...
    const result = await model.generateContent(prePromptData + prompt + postPromptData);
